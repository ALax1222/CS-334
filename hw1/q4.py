...
def add_irr_feature(xTrain, xTest):
    ...
    for i in range(len(xTrain)):
        useless1.append(random.gauss(mu, sigma))
        useless2.append(random.gauss(mu, sigma))

    xTrain["Useless1"] = useless1
    xTrain["Useless2"] = useless2
    ...
    xTest["Useless1"] = useless1
    xTest["Useless2"] = useless2
